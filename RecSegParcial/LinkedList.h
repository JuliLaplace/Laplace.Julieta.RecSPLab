...
/** \brief Funcion que filtra elementos (segun funcion que se le pase) y los devuelve cargados en un nuevo Linkedlist
 *
 * \param this LinkedList* linkedlist  a filtrar
 * \param int(*pFunc)(void*) puntero a funcion que se utilizara como parametro para filtrar
 * \return LinkedList* retorna un puntero a una nueva linkedlist con el filtro realizado
 *
 */
LinkedList* ll_filter(LinkedList* this, int (*pFunc) (void* pElements));
